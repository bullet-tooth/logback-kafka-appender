package com.github.bullettooth.logback.kafka.keying;
...
public class ContextNameKeyingStrategyTest {
    ...
    public void shouldPartitionByEventThreadName() {
        ...
        MatcherAssert.assertThat(unit.createKey(evt), Matchers.equalTo(ByteBuffer.allocate(4).putInt(LOGGER_CONTEXT_NAME.hashCode()).array()));
    }
}
